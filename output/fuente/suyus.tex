...
\begin{textblock}{191}(-16,0)
 \centering
 \includegraphics[width=1\textwidth]{../static/terrazas_arroz_c}
\end{textblock}

 \begin{textblock}{160}(0,4)
  \LARGE \centering \textcolor{black!5}{Evaluación de modelos causales reales}\\
 \end{textblock}
%
...
\begin{textblock}{153}(2,65.5)
\LARGE  \textcolor{black!5}{\rotatebox[origin=tr]{0}{\scalebox{6}{\scalebox{1}[-1]{$p$}}}}
\end{textblock}
\begin{textblock}{153}(2,43)
\LARGE \textcolor{black!5}{\scalebox{6}{$p$}}
\end{textblock}
\begin{textblock}{153}(14,62.2)
\textcolor{black!5}{\rotatebox[origin=tr]{90}{\scalebox{6}{$|$}}}
\end{textblock}
